...
pointcloud_v2-compatible Stage1 that uses point_cloud_cam as the raw completion input.
"""
...
PIPELINE_SCRIPT = os.path.join(SCRIPT_DIR, "pipeline_inputs_to_zcopy_robust_stereo_switch_pointcloud_v2.py")
