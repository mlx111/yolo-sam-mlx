...
"""
Pipeline:
1) Build object point cloud from left depth + object mask.
...
def run(cfg: Config) -> Dict[str, object]:
    ...
    depth_path = os.path.join(cfg.input_root, cfg.left_depth_rel)
    mask_path = os.path.join(cfg.input_root, cfg.left_mask_tpl.format(obj=cfg.object_name))
