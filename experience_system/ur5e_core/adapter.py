"""UR5e MemoryV3+ -> universal experience adapter."""
...
from .schema import UR5E_BACKEND, UR5E_NAMESPACE, UR5E_ROBOT_TYPE


class Wrapper1UR5eAdapter:
    robot_type = UR5E_ROBOT_TYPE
    backend = UR5E_BACKEND
    ...
    def normalize_entry(self, raw_entry: dict[str, Any]) -> ExperienceEntry:
        ...
        entry = ExperienceEntry(
            ...
            embodiment={"control_mode": "actuator_or_wrapper", "grasp_mode": "mujoco_contact_friction"},
            scenario={
            ...
            raw_refs={
                "source_format": "ur5e_mujoco.memory_v3_plus",
