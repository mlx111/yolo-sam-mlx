...
class Ur5eFieldAtomicSkillSpec:
    name: str
    action: str
    description: str = ""
...
def default_field_atomic_skill_specs() -> list[Ur5eFieldAtomicSkillSpec]:
    return [
        Ur5eFieldAtomicSkillSpec(
            name="camera_rgbd_save",
            action="camera_rgbd_save",
            description="Render and save the current UR5e cam1 RGB-D observation for recovery.",
            parameter_schema={},
        ...
        Ur5eFieldAtomicSkillSpec(
            ...
            description="Move UR5e TCP to the fixed vertical pregrasp pose.",
            parameter_schema={
        ...
        Ur5eFieldAtomicSkillSpec(
            ...
            description="Move UR5e TCP from pregrasp to the fixed vertical grasp pose.",
            parameter_schema={
        ...
        Ur5eFieldAtomicSkillSpec(
            ...
            description="Close the UR5e gripper and rely on MuJoCo contact/friction to hold the target.",
            parameter_schema={},
        ...
        Ur5eFieldAtomicSkillSpec(
            name="open_gripper",
            action="open_gripper",
            description="Open the UR5e gripper and release the physically held target.",
            parameter_schema={},
        ...
        Ur5eFieldAtomicSkillSpec(
            name="go_home",
            action="go_home",
            description="Return UR5e to the safe/home joint posture.",
            parameter_schema={},
